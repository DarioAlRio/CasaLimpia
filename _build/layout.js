      ...
      <div class="foot-grid">
        <div class="foot-brand">
          ...
          <p class="foot-contact">
            ${icon("mail")}
            <a href="#" class="js-mail" data-correo="hola|casalimpia.es">activar JavaScript para ver el correo</a>
          </p>
        </div>
        ${columnas}
      </div>
...
function pageHero({ eyebrow, title, dek, updated, img, imgAlt }) {
  return `<section class="page-hero">
    <div class="wrap">
      ...
      ${img ? `<figure class="page-hero-media"><img src="${img}" alt="${escapeHtml(imgAlt || "")}" loading="lazy" width="1200" height="500"></figure>` : ""}
    </div>
  </section>`;
}
...
function ctaBand() {
  return `<section class="cta-band">
    <div class="wrap">
      ...
      <p>Empieza por la guía que más te interese ahora mismo: robots aspiradores, mopas eléctricas o limpiadores a vapor.</p>
